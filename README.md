# pokeapi-go
![Actions](https://github.com/dkanomad/pokeapi-go/workflows/Actions/badge.svg)
...
[![Go Report Card](https://goreportcard.com/badge/github.com/dkanomad/pokeapi-go?style=flat)](https://goreportcard.com/report/github.com/dkanomad/pokeapi-go)
[![GoDoc](https://img.shields.io/badge/go-documentation-blue.svg?style=flat)](http://godoc.org/github.com/dkanomad/pokeapi-go)
...
```bash
go get github.com/dkanomad/pokeapi-go
```

```go
import "github.com/dkanomad/pokeapi-go"
```
